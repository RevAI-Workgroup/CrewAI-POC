...
| 1-3 | [Basic FastAPI Application](mdc:PBI-001-3.md) | Proposed | Create FastAPI app with health check endpoint |
...
| 1-8 | [Workspace and Thread Models](mdc:PBI-001-8.md) | Proposed | Implement Workspace and Thread models |
